...
public class Game extends Canvas {
	...
	public static final String TITLE = "GOTY: The Game v" + VERSION;

	//initial configs

	private static final int BOMBRATE = Bomberman.BOMBRATE_;
	private static final int BOMBRADIUS = Bomberman.BOMBRADIUS_;
	private static final double PLAYERSPEED = Bomberman.PLAYERSPEED_;

	public static final int TIME = Bomberman.TIME_;
	public static final int POINTS = Bomberman.POINTS_;
	public static final int LIVES = Bomberman.LIVES_;
